...
ap.add_argument("-p", "--prototxt", required=True, help=r'C:\Users\zkksa\OneDrive\Desktop\MEGA\SSD_MobileNet_prototxt.txt')
ap.add_argument("-m", "--model", required=True, help=r'C:\Users\zkksa\OneDrive\Desktop\MEGA\SSD_MobileNet.caffemodel')
